...
const Header = () => {
    ...
    <ul className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg opacity-0 transform scale-95 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-100">
        ...
        <li><a href="#" className="block px-4 py-2 text-gray-700 hover:text-[#ff6000] hover:bg-orange-200 hover:rounded-lg">Resources</a></li>
            ...
            {/* <button type="button" className="blinking-button md:flex hidden absolute bottom-4 right-4 text-[#ff6000] hover:text-white hover:bg-[#ff6000] rounded-full bg-white py-1 px-6 font-medium text-lg transition-colors duration-200 z-10">
                <span className="absolute top-0 right-0 -mt-2 -mr-2 bg-[#ff6000] text-white text-xs font-bold px-2 py-1 rounded-full">3</span>
                Life at Singer
            </button> */}
    ...
    <ul className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg opacity-0 transform scale-95 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-100">
        ...
        <li><a href="#" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Sub Service 3</a></li>
                  ...
                  {/* <li><button type="button" class=" px-8 rounded-full shadow-md hover:shadow-xl bg-white bg-[#ff6000] hover:bg-[#551515] font-medium text-base transition-colors duration-200 z-10">
                                <a href="#" class="px-4 block md:hover:bg-transparent hover:text-gray-200 md:p-0 text-white">
                                    Singer සත්කාර 
                                    <img className='h-6' src='/Sathkaara.jpeg'></img>
                                </a>
                    ...
                    {/* <li>
                        <button type="button" className="blinking-button absolute bottom-4 mx-auto text-[#ff6000] hover:text-white hover:bg-[#ff6000] rounded-full bg-white py-1 px-6 font-medium text-lg transition-colors duration-200 z-10">
                <span className="absolute top-0 right-0 -mt-2 -mr-2 bg-[#ff6000] text-white text-xs font-bold px-4 py-1 rounded-full">3</span>
                Life at Singer
            </button>
                    </li> */}
            ...
            {/* <button type="button" className="blinking-button absolute bottom-4 right-4 text-[#ff6000] hover:text-white hover:bg-[#ff6000] rounded-full bg-white py-1 px-6 font-medium text-lg transition-colors duration-200 z-10">
                <span className="absolute top-0 right-0 -mt-2 -mr-2 bg-[#ff6000] text-white text-xs font-bold px-2 py-1 rounded-full">3</span>
                Life at Singer
            </button> */}
        </div>
